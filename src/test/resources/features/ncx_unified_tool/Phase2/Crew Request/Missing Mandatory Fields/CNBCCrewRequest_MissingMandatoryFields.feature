@CNBCCrewRequest_Nagative @ProducerDashboard @Negative @CNBCCrewRequest
Feature: Validate various scenarios related CNBC Crew
  ...
  @CNBCCrewRequest_Missing_all_field
  Scenario Outline: Verify user submit button without filling any fields in CNBC Crew request form
    ...
    Then Verify error message is displayed for all mandatory fields in general details section for CNBC Crew form
      | Slug Error    |
      | Enter a value |
    Then Verify error message is displayed for all mandatory fields in producer deatils section for CNBC Crew form
      | Producer Error | Sr Producer Error | Is There An Onsite Producer Error |
      | Select a value | Select a value    | Select a value                    |
    Then Verify error message is displayed for all mandatory fields in field contact section for CNBC Crew form
      | Producer Cell Number Error |
      | Enter a value              |
    Then Verify error message is displayed for all mandatory fields in show info section for CNBC Crew form
      | Show Title Budget Code Error |
      | Select a Budget Code         |
    Then Verify error message is displayed for all mandatory fields in shoot details section In CNBC Crew form
      | Production Type Error | Shoot Description Error |
      | Select a value        | Enter a value           |
    Then Verify error message is displayed for all mandatory fields in shoot specs section In CNBC Crew form
      | Audio Needs Error | Special Conditions Error | Transmission Type Error | Drone Shoot Error |
      | Select a value    | Select a value           | Select a value          | Select a value    |
    Then Verify error message is displayed for all mandatory fields in shoot location section In CNBC Crew form
      | Address Error | City Error    | State Error    | Country Error  |
      | Enter a value | Enter a value | Select a value | Select a value |
    Then Verify error message is displayed for all mandatory fields in date & time section In CNBC Crew form
  ...
  @CNBCCrewRequest_Missing_mandatory_field
  Scenario Outline: Verify user submit button with filling only non mandatory fields in CNBC Crew request form
    ############################ user submitting the general details form ############################
    And user clicks on forms link
    And user selects "<Form Name>" form
  ...
  @CNBCCrewRequest_Missing_non_mandatory_field
  Scenario Outline: Verify user submit button with filling only mandatory fields in CNBC Crew request form
    ############################ user submitting the general details form ############################
    And user clicks on forms link
    And user selects "<Form Name>" form
    Then user enters General info in CNBC Crew form
  ...
  @CNBCCrewRequest_no_Missing_field
  Scenario Outline: Verify user submit button with filling all fields in CNBC Crew request form
    ############################ user submitting the general details form ############################
    And user clicks on forms link
    And user selects "<Form Name>" form
    Then user enters General info in CNBC Crew form
