@CNBCCrewRequest @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related CNBC Crew
  ...
  @CNBCCrewRequest_e2e @SEVERITY=CRITICAL @CrewE2E
  Scenario Outline: Verify user filling CNBC Crew Request form
    ...
    Examples: #Resource Standard
      ...
      | CNBC Crew | Resource-Standard | Wind | Solai-Magesh | Magesh   | Jeevanandham | test1/test1/test1/test1-test2/test2/test2/test2 | CNBC,News  | Tent         | Houston Bureau | CurrentDate+3    | CurrentDate+9  | CurrentTime+1 |
