@NBCNewsCrewRequest @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related NBC News Crew
  ...
  @NBCNewsCrewRequest_e2e @SEVERITY=CRITICAL @CrewE2E
  Scenario Outline: Verify user filling NBC News Crew Request form
    ...
    Examples: #Resource Standard
      ...
      | NBC News  | Resource       | Wind | Solai-Sainath | Magesh   | Jeevanandham | test1/test1/test1/test1-test2/test2/test2/test2 | CNBC,News  | Tent         | Houston Bureau | CurrentDate+3    | CurrentDate+9  | CurrentTime+1 |
