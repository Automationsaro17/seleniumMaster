@DigitalJournalistDJShootCrewRequest @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related Digital Journalist DJ Shoot Crew
  ...
  @DigitalJournalistDJShootCrewRequest_e2e @SEVERITY=CRITICAL @CrewE2E
  Scenario Outline: Verify user filling Digital Journalist DJ Shoot Crew Request form
    ...
    Examples: #Resource Standard
      ...
      | Digital Journalist / DJ Shoot | Resource       | Wind | Solai-Sainath | Magesh   | Jeevanandham | test1/test1/test1/test1-test2/test2/test2/test2 | CNBC,Show  | Tent         | Houston Bureau | CurrentDate+3    | CurrentDate+9  | CurrentTime+1 |
