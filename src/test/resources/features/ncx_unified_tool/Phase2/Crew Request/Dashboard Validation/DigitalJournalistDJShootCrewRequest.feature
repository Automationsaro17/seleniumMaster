...
Feature: Validate various scenarios related Digital Journalist DJ Shoot Crew
  ...
  @DigitalJournalistDJShootCrewRequest_Dashboard_Validation
  Scenario Outline: Verify user filling Digital Journalist DJ Shoot Crew Request form and validating in dashboard
    ...
    Then verify all fields in the Digital Journalist DJ Shoot Crew form are matching with "<Dashboard Name>" view columns in crew dashboard
      | Status | Color | Shoot Start Date   | Shoot Status   | Slug   | Shoot Location    | Talent   | Show Title   | Requesters   | Producer   | Sr Producer   | Submitted   |
      | New    | Pink  | <Shoot Start Date> | <Shoot Status> | <Slug> | <Shoot Location > | <Talent> | <Show Title> | <Requesters> | <Producer> | <Sr Producer> | CurrentDate |
    Then verify resource count and crew details in the Digital Journalist DJ Shoot Crew form are matching with "<Dashboard Name>" view columns in crew dashboard
