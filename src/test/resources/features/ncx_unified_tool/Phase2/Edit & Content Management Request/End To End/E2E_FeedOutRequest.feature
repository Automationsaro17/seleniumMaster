@FeedOutRequest @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related ECM request
  ...
  @FeedOut_e2e @SEVERITY=CRITICAL
  Scenario Outline: Verify user creating Feed Out request flow of "<Form Name>" form and Fulfillment
    ...
    Then verify all fields in the Feed Out form are matching with columns in content management dashboard
      | Status  | Color  | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Final Destination   | Requesters   | Producer   | Sr Producer   | Source   | Content Description   | Submitted   |
      | REVISED | Orange | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Final Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Content Description> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    And user enters fulfillment info in Feed Out Fulfillment section
      | Destinations  | Media ID | Feed Time     | Device Timer Hours | Device Timer Minutes | Device Timer Seconds | Clip Count | Fulfiller Comments                                                      |
      | CNBC - London |   324235 | CurrentTime+3 |                  8 |                   30 |                   56 |          6 | Fulfillment testr Fulfillment testr Fulfillment testr Fulfillment testr |
    ...
    Then verify all fields in the Feed Out form are matching with columns in content management dashboard
      | Status      | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Final Destination   | Requesters   | Producer   | Sr Producer   | Source   | Content Description   | Submitted   |
      | IN PROGRESS | Blue  | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Final Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Content Description> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the Feed Out form are matching with columns in content management dashboard
      | Status    | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Final Destination   | Requesters   | Producer   | Sr Producer   | Source   | Content Description   | Submitted   |
      | COMPLETED | Green | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Final Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Content Description> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the Feed Out form are matching with columns in content management dashboard
      | Status               | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Final Destination   | Requesters   | Producer   | Sr Producer   | Source   | Content Description   | Submitted   |
      | CONFIRM CANCELLATION | Grey  | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Final Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Content Description> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the Feed Out form are matching with columns in content management dashboard
      | Status    | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Final Destination   | Requesters   | Producer   | Sr Producer   | Source   | Content Description   | Submitted   |
      | CANCELLED | Black | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Final Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Content Description> | CurrentDate |
    ##############################Email Validation###########################################
