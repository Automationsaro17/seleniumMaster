@ER_Standard @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related ECM request
  ...
  @ER_Standard_e2e @SEVERITY=CRITICAL
  Scenario Outline: Verify user creating Edit request Standard flow of "<Form Name>" form and Fulfillment
    ...
    Examples: 
      ...
      | Standard Edit | Wind | Engineering | Solai-Sainath | Magesh   | Jeevanandham | test1/test1/test1/test1-test2/test2/test2/test2 | CNBC,MSNBC | T-EDT22NNN.J047 | CurrentDate+3 | CurrentTime+3 | London   | CurrentDate+15  | No    |
