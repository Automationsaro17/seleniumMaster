@MTD @ProducerDashboard @END_TO_END
Feature: Validate various scenarios related ECM request
  ...
  @MTD_e2e @SEVERITY=CRITICAL
  Scenario Outline: Verify user creating MTD requests flow of "<Form Name>" form
    ...
    Then verify all fields in the MTD form are matching with columns in content management dashboard
      | Status  | Color  | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Destination   | Requesters   | Producer   | Sr Producer   | Source   | Camera   | Submitted   |
      | REVISED | Orange | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Camera> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    And user enters fulfillment info in MTD Fulfillment section
      | Destinations                | File Format | Gig Size | Clip Count | Device Timer Hours | Device Timer Minutes | Device Timer Seconds | Fulfiller Comments                                                      |
      | CNBC Dropbox, Media Shuttle | .asf,.gif   |       32 |         18 |                 30 |                   56 |                    6 | Fulfillment testr Fulfillment testr Fulfillment testr Fulfillment testr |
    ...
    Then verify all fields in the MTD form are matching with columns in content management dashboard
      | Status      | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Destination   | Requesters   | Producer   | Sr Producer   | Source   | Camera   | Submitted   |
      | IN PROGRESS | Blue  | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Camera> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the MTD form are matching with columns in content management dashboard
      | Status    | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Destination   | Requesters   | Producer   | Sr Producer   | Source   | Camera   | Submitted   |
      | COMPLETED | Green | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Camera> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the MTD form are matching with columns in content management dashboard
      | Status               | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Destination   | Requesters   | Producer   | Sr Producer   | Source   | Camera   | Submitted   |
      | CONFIRM CANCELLATION | Grey  | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Camera> | CurrentDate |
    ##############################Email Validation###########################################
    ...
    Then verify all fields in the MTD form are matching with columns in content management dashboard
      | Status    | Color | Slug   | Show Unit   | Division   | Date Needed By   | Time Needed By   | Destination   | Requesters   | Producer   | Sr Producer   | Source   | Camera   | Submitted   |
      | CANCELLED | Black | <Slug> | <Show Unit> | <Division> | <Date Needed By> | <Time Needed By> | <Destination> | <Requesters> | <Producer> | <Sr Producer> | <Source> | <Camera> | CurrentDate |
    ##############################Email Validation###########################################
